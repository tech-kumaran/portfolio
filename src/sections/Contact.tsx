...
export function Contact() {
  ...
  const handleDownloadResume = () => {
    ...
    link.download = 'Kumaran-Resume.pdf';
  ...
  return (
    <section id="contact" className="py-20 sm:py-24 md:py-32 bg-[#0b0716] text-white relative overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-stretch">
          ...
          <AnimatedSection delay={0.2}>
            <div className="flex flex-col h-full space-y-8">
              <div className="bg-white/5 border border-white/10 p-8 rounded-3xl backdrop-blur-sm shadow-xl">
                <h3 className="text-2xl font-bold text-white mb-8">Connect Details</h3>
                <div className="space-y-6">
                  <a href="mailto:kumarandev.tech@gmail.com" className="flex items-center gap-5 p-4 rounded-xl hover:bg-white/5 transition-all group">
                    ...
                    <div>
                      ...
                      <p className="text-lg text-white font-bold group-hover:text-accent transition-colors">kumarandev.tech@gmail.com</p>
                    </div>
                  </a>

                  <a href="https://www.linkedin.com/in/m-kumaran-435611187/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-5 p-4 rounded-xl hover:bg-white/5 transition-all group">
                    ...
                    <div>
                      ...
                      <p className="text-lg text-white font-bold group-hover:text-blue-400 transition-colors">/in/m-kumaran</p>
                    </div>
                  </a>
                  ...
                  <div className="flex items-center gap-5 p-4 rounded-xl hover:bg-white/5 transition-all group">
                    ...
                    <div>
                      ...
                      <p className="text-lg text-white font-bold">Bangalore, India</p>
                    </div>
                  </div>

                  <a href="tel:8695266945" className="flex items-center gap-5 p-4 rounded-xl hover:bg-white/5 transition-all group">
                    ...
                    <div>
                      ...
                      <p className="text-lg text-white font-bold group-hover:text-purple-400 transition-colors">+91 86952 66945</p>
                    </div>
                  </a>
                </div>
              </div>
          ...
          <AnimatedSection delay={0.4}>
            <div className="bg-white/5 border border-white/10 p-8 sm:p-10 rounded-3xl backdrop-blur-sm shadow-2xl h-full flex flex-col">
              ...
              <p className="text-slate-400 mb-8">I usually respond within 24 hours</p>
